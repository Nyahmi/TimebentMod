...
package net.mcreator.ulterra.world.biome;
...
public class BiomeDevTest extends ElementsUlterra.ModElement {
	@GameRegistry.ObjectHolder("ulterra:devtest")
	public static final BiomeGenCustom biome = null;
	public BiomeDevTest(ElementsUlterra instance) {
		super(instance, 26);
	}
	...
	static class CustomTree extends WorldGenAbstractTree {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (position.getY() < world.getHeight() - height - 1) {
						world.setBlockState(position.down(), BlockAncientStone.block.getDefaultState(), 2);
						...
						for (int genh = 0; genh < height; genh++) {
							...
							if (state.getBlock().isAir(state, world, genhPos) || state.getBlock() == Blocks.AIR.getDefaultState().getBlock()
									|| state.getBlock() == Blocks.AIR.getDefaultState().getBlock()) {
								this.setBlockAndNotifyAdequately(world, position.up(genh), BlockAncientCobblestone.block.getDefaultState());
							}
						}
		...
		protected void setDirtAt(World world, BlockPos pos) {
			if (world.getBlockState(pos).getBlock() != BlockAncientStone.block.getDefaultState().getBlock())
				this.setBlockAndNotifyAdequately(world, pos, BlockAncientStone.block.getDefaultState());
		}
