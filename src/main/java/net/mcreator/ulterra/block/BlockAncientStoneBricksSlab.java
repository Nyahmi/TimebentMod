...
public class BlockAncientStoneBricksSlab extends ElementsUlterra.ModElement {
	@GameRegistry.ObjectHolder("ulterra:ancientstonebricksslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("ulterra:ancientstonebricksslab_double")
	public static final Block block_slab_double = null;
	public BlockAncientStoneBricksSlab(ElementsUlterra instance) {
		super(instance, 22);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ancientstonebricksslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ancientstonebricksslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("ulterra:ancientstonebricksslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("ancientstonebricksslab");
