...
public class BlockAncientCobblestoneSlab extends ElementsUlterra.ModElement {
	@GameRegistry.ObjectHolder("ulterra:ancientcobblestoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("ulterra:ancientcobblestoneslab_double")
	public static final Block block_slab_double = null;
	public BlockAncientCobblestoneSlab(ElementsUlterra instance) {
		super(instance, 20);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ancientcobblestoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ancientcobblestoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("ulterra:ancientcobblestoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("ancientcobblestoneslab");
