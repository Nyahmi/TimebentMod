...
public class BlockAncientPlanksSlab extends ElementsUlterra.ModElement {
	@GameRegistry.ObjectHolder("ulterra:ancientplanksslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("ulterra:ancientplanksslab_double")
	public static final Block block_slab_double = null;
	public BlockAncientPlanksSlab(ElementsUlterra instance) {
		super(instance, 24);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ancientplanksslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ancientplanksslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("ulterra:ancientplanksslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("ancientplanksslab");
