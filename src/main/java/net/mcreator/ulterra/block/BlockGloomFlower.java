...
import net.mcreator.ulterra.world.WorldNuLyra;
import net.mcreator.ulterra.ElementsUlterra;

import java.util.Random;

@ElementsUlterra.ModElement.Tag
public class BlockGloomFlower extends ElementsUlterra.ModElement {
	@GameRegistry.ObjectHolder("ulterra:gloomflower")
	public static final Block block = null;
	public BlockGloomFlower(ElementsUlterra instance) {
		super(instance, 31);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("ulterra:gloomflower", "inventory"));
	}

	@Override
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		boolean dimensionCriteria = false;
		if (dimID == WorldNuLyra.DIMID)
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0.8F);
			setUnlocalizedName("gloomflower");
			setRegistryName("gloomflower");
		}
